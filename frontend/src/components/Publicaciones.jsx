                ...
                <div className="row border-radius" key={index}>
                    <div className="feed">
                        <div className="feed_title">
                            ...
                            <span>
                                <b>{publicacion.usuario_publicacion ? publicacion.usuario_publicacion.usuario : 'Usuario Desconocido'}</b> hizo una <Link to={`/publicacion/${publicacion._id}`}>Publicación</Link>
