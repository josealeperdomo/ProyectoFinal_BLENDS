                ...
                <div className="publish">
                    ...
                    <form method="" action="/">
                        <div className="publish_textarea">
                            <img className="border-radius-image" src="images/user.jpg" alt="" />
                            <textarea type="text" placeholder="¿Whats up, Jonh?" ></textarea>
            ...
            <div className="row border-radius">
                <div className="feed">
                    <div className="feed_title">
                        ...
                        <span><b>Marina Valentine</b> hizo una <a href="">Publicacion</a><p>March 2 at 6:05pm</p></span>
                    </div>
                ...
                <div className="feed">
                    ...
                    <div className="feed_footer">
                        <div className="feed_footer_left">
                            <li className="hover-orange selected-orange"><i className="fa fa-heart"></i> 159</li>
                        ...
                        <div className="feed_footer_right">
                            <div>
                            <li className="hover-orange selected-orange"><i className="fa fa-share"></i> 7k</li>
                            <a href="feed.html" ><li className="hover-orange"><i className="fa fa-comments-o"></i> 54 comments</li></a>
