...
export function Amigos() {
  ...
  useEffect(() => {
    const obtenerAmigos = async () => {
      try {
        ...
        const response = await axios.get(`https://estudiantes12.backendprueba.xyz/users/amigos/${id}`);
  ...
  const handleEliminarAmigo = async (idAmigo) => {
    try {
      ...
      await axios.patch('https://estudiantes12.backendprueba.xyz/amistad/eliminarAmigo', {
